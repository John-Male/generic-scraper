...
creates `fixtures/configs/retry.yaml` (and any per-attempt-count variants the
procedures need) against the finalized `ScraperType` schema and keeps it in
step with `qa/08_error_handling_and_retries.md`.
